...
<table class="table table-action">
    ...
    <td>
      ...
      <td><img src="<?PHP echo $item['Produto']['img']; ?>" class="img-responsive" ><?PHP echo $item['Produto']['nome']; ?></td>    
        ...
        <a href="javascript:void(0);" class="excluir" indice="<?PHP echo $i; ?>" plataforma="web" host="<?PHP echo $host; ?>/carrinho-ajax" 
        	...
        	<img src="smartphone/images/x.png" width="15" height="15"></a>
        </td>
      </tr>
     <?PHP 
	    $i++;
    ...
    <tr>
        <td><?PHP if($_SESSION['pedido']['borda'] == 'S'){ ?>  		
	    		<input type="checkbox" 
